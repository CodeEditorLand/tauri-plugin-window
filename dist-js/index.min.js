...
var g = (a, b) => {
	for (var c in b) f$1(a, c, { get: b[c], enumerable: !0 });
};
var e = (a, b, c) => {
	if (!b.has(a)) throw TypeError("Cannot " + c);
};
var h$1 = (a, b, c) => (
		e(a, b, "read from private field"), c ? c.call(a) : b.get(a)
	),
	i$1 = (a, b, c) => {
		if (b.has(a))
			throw TypeError(
...
async function m(n, e, t) {
	...
	return (
		(r.onmessage = t),
		u(`plugin:${n}|register_listener`, { event: e, handler: r }).then(
			() => new a(n, e, r.id),
		)
	);
}
...
async function c(n, t, i) {
	return u("plugin:event|listen", {
		event: n,
		windowLabel: i?.target,
		handler: s$1(t),
	}).then((r) => async () => s(n, r));
}
async function W(n, t, i) {
	return c(
		n,
		(r) => {
			t(r), s(n, r.id).catch(() => {});
...
class Window {
	...
	async onResized(handler) {
		return this.listen(l.WINDOW_RESIZED, (e) => {
	...
	async onMoved(handler) {
		return this.listen(l.WINDOW_MOVED, (e) => {
